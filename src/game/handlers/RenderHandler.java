...
public class RenderHandler {
	...
	/**
	 * Renders the {@linkplain Sprite}s. 
	 * @param g2d
	 */
	public void renderSprites(Graphics2D g2d, List<Sprite> sprites) {
		for (Sprite s : sprites) {
			g2d.drawImage(s.getImage(), (int) s.getX(), (int) s.getY(), s.getWidth(), s.getHeight(), null);
		}
	}

	/**
	 * Renders the {@linkplain Effect}s. 
	 * @param g2d
	 */
	public void renderEffects(Graphics2D g2d, List<Effect> effects) {
