...
public class MainMenuButton extends Mob {
	...
	public MainMenuButton(float x, float y, int id, Level level) {
	...
	private void initGFX() {
		setImage(SpriteHandler.getMobImage("MainMenuButton"));
