...
public class RestartButton extends Mob {
	...
	public RestartButton(float x, float y, int id, Level level) {
	...
	private void initGFX() {
		setImage(SpriteHandler.getMobImage("RestartButton"));
