...
public class HostButton extends Mob {
	...
	public HostButton(float x, float y, int id, Level level) {
	...
	private void initGFX() {
		setImage(SpriteHandler.getMobImage("HostButton"));
