...
public class MultiplayerButton extends Mob {
	
	public static final float HEALTH = 100;
	public static final float MAXHEALTH = 100;
	public static final float SPEED = 3f;
	public static final String NAME = "Multiplayer";
	private Level level;
	
	private int tickCount = 0;
	private boolean moveUp = false;
	
	public MultiplayerButton(float x, float y, int id, Level level) {
	...
	private void initGFX() {
		setImage(SpriteHandler.getMobImage("MultiplayerButton"));
