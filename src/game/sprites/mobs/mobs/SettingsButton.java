...
public class SettingsButton extends Mob {
	...
	public SettingsButton(float x, float y, int id, Level level) {
	...
	private void initGFX() {
		setImage(SpriteHandler.getMobImage("SettingsButton"));
