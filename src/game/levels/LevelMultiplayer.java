...
public class LevelMultiplayer extends Level {
	...
	private void initMobs() {
		...
		getMobs().add(new JoinButton(Game.GAME_MAX_WIDTH-200, Game.GAME_MAX_BORDER * .43f, 0, this));
		getMobs().add(new HostButton(Game.GAME_MAX_WIDTH-200, Game.GAME_MAX_BORDER * .59f, 1, this));
		getMobs().add(new MainMenuButton(Game.GAME_MAX_WIDTH-200, Game.GAME_MAX_BORDER * .75f, 2, this));
	}
